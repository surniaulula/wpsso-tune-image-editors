 ...
 * Copyright 2018-2021 Jean-Sebastien Morisset (https://wpsso.com/)
 */
...
if ( ! class_exists( 'WpssoTieSubmenuTieGeneral' ) && class_exists( 'WpssoAdmin' ) ) {
	...
	class WpssoTieSubmenuTieGeneral extends WpssoAdmin {
		...
		protected function add_meta_boxes() {
			...
			$notice_msg = '<p>' . __( 'After activating the %1$s add-on or changing its settings,<br/>don\'t forget to <a href="%2$s">regenerate all image thumbnail and image sizes</a> to see the results.', 'wpsso-tune-image-editors' ) . '</p>';
