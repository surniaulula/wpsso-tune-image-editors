...
if ( ! class_exists( 'WpssoTieRegister' ) ) {

	class WpssoTieRegister {

		public function __construct() {
			register_activation_hook( WPSSOTIE_FILEPATH, array( &$this, 'network_activate' ) );
			//register_deactivation_hook( WPSSOTIE_FILEPATH, array( &$this, 'network_deactivate' ) );	// nothing to do
