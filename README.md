<h1>WPSSO Tune WP Image Editors</h1><h3>The Easiest (and Only) Way to Sharpen Social and SEO Images</h3>
...
<p><strong>Have you noticed that WordPress creates small images that seems a bit "fuzzy"</strong> &mdash; nothing like the nice sharp original you uploaded?</p>

<p><strong>The reason is that after resizing any image, <em>that image must be sharpened</em></strong> &mdash; but WordPress doesn't do any sharpening, so the resized image remains a bit "fuzzy" &mdash; not what you want for a featured image or shared image on social sites! ;-)</p>

<p>The WPSSO Tune WP Image Editors (aka WPSSO TIE) add-on takes care of this &mdash; it automatically applies a default amount of sharpening to all JPEG images resized by the WordPress ImageMagick editor.</p>

<p>WPSSO TIE is compatible with all image compression / optimization plugins &mdash; it applies sharpening during the image resize operation, and the resulting resized image can be optimized as usual.</p>
