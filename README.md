...
<p>WPSSO TIE is compatible with all image compression / optimization plugins &mdash; it applies sharpening during the image resize operation, so the resulting resized image can be optimized as usual.</p>
